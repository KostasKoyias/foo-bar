...
With that information, you can figure out which list contains the number of access codes that matches the number of 
locks on the door when you're ready to go in (for example, if there's 5 pass-codes, 
...
Some of the lists are purposely generated without any access codes to throw off spies, 
