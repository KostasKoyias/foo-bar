...
from the space station as quickly and as orderly as possible! 
...
Write a function solution(entrances, exits, path) 
that takes an array of integers denoting where the groups of gathered bunnies are, 
